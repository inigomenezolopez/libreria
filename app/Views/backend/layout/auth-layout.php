...
<head>
	...
	<!-- Site favicon -->
	<link rel="apple-touch-icon" sizes="180x180" href="/libreria/public/backend/vendors/images/apple-touch-icon.png" />
	<link rel="icon" type="image/png" sizes="32x32" href="/libreria/public/backend/vendors/images/favicon-32x32.png" />
	<link rel="icon" type="image/png" sizes="16x16" href="/libreria/public/backend/vendors/images/favicon-16x16.png" />
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-7">
					<img src="/libreria/public/backend/vendors/images/login-page-img.png" alt="" />
				</div>
