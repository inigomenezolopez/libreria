        ...
        <div class="col-md-3 bg-light p-3 d-flex flex-column justify-content-start">
            <div class="mb-5 pt-5 text-center">
                ...
                <div class="list-group mb-5 d-flex flex-column align-items-center">
                    ...
                    <a href="<?= base_url(route_to('todos-los-comics')) ?>?category=<?= $category['category'] ?>"
                        class="d-inline-block text-decoration-none mb-2 p-2 text-dark text-center"
                        style="width: 50%; border-radius: 15px; transition: background-color 0.3s ease; background-color: transparent; border: 1px solid #dc3545;"
                        onmouseover="this.style.backgroundColor='#ff7f7f';"
                        onmouseout="this.style.backgroundColor='transparent';"><?= $category['category'] ?></a>
                    <?php endforeach; ?>
                </div>
